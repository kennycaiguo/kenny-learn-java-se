...
public class LuceneNewUtil {
	...
	public static void WriteIndex(Object obj) throws Exception {
		Document d=LuceneNewUtil.Javabean2Document(obj);
		Version ver=LuceneNewUtil.getVersion();
		Analyzer analyzer=LuceneNewUtil.getAnalyzer();
		Directory dir=LuceneNewUtil.getDirectory();
	...
	public static List<luceneApp.entity.Article> SearchIndex(String keyword) throws Exception {
		...
		//2.创建QueryParser对象
		//QueryParser paser=new QueryParser(ver,"content",analyzer) ; //这是单字段搜索
	QueryParser paser=new MultiFieldQueryParser(LuceneNewUtil.getVersion(),new String[]{"title","content"},LuceneNewUtil.getAnalyzer()) ; //这是多字段搜索
		...
		for(int i=0;i<tdocs.scoreDocs.length;i++) {
		  ...
		  //8创建JavaBean对象
		    ...
		    a=(Article) LuceneNewUtil.Document2JavaBean(d,Article.class);
...
public static void deleteIndex(Term t) throws IOException, Exception {
		...
		IndexWriter idw=LuceneNewUtil.getIndexWriter();
...
public static void deleteAllIndex() throws IOException, Exception {
	...
	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
         ...
         Document d=LuceneNewUtil.Javabean2Document(a);
//          System.out.println(d.get("id"));
//          System.out.println(d.get("title"));
//          System.out.println(d.get("content"));
         Article article=(Article) LuceneNewUtil.Document2JavaBean(d, Article.class);
