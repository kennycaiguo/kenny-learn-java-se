...
public class LuceneUtil1 {
	...
	public static void WriteIndex(Object obj) throws Exception {
		Document d=LuceneUtil1.Javabean2Document(obj);
		Version ver=LuceneUtil1.getVersion();
		Analyzer analyzer=LuceneUtil1.getAnalyzer();
		Directory dir=LuceneUtil1.getDirectory();
	...
	//封装搜索方法
	public static List<lucenepaging.entity.Article> SearchIndex(String keyword) throws Exception {
		...
		for(int i=0;i<tdocs.scoreDocs.length;i++) {
		    ...
		    a=(Article) LuceneUtil1.Document2JavaBean(d,Article.class);
...
public static void deleteIndex(Term t) throws IOException, Exception {
		...
		IndexWriter idw=LuceneUtil1.getIndexWriter();
...
public static void deleteAllIndex() throws IOException, Exception {
	...
	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
         ...
         Document d=LuceneUtil1.Javabean2Document(a);
//          System.out.println(d.get("id"));
//          System.out.println(d.get("title"));
//          System.out.println(d.get("content"));
         Article article=(Article) LuceneUtil1.Document2JavaBean(d, Article.class);
